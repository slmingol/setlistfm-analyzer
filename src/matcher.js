const TRIBUTE_RE = /\btribute\b|\bcover\s*band\b|\bcelebrating\b|\bthe music of\b|\bsalute to\b|the\s+.+\s+story\b|the\s+.+\s+experience\b|\bstory songs\b|\bsongs of the\b/i;
